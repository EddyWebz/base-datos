...
const pool = require('./database/database-promise'); // CONFIGURADO PARA USAR PROMESAS
...
router.get('/notificaciones', async (req, res) => {
    ...
    const pool = req.connection; // OBTENER LA CONEXIÓN DESDE `req`
...
router.get('/reportes', async (req, res) => {
    ...
    try {
        ...
        const [reportes] = await pool.query(`
            ...
            ORDER BY garage ASC, habitacion ASC
        `, [user_id, startDate, endDate]); // CAMBIO A PROMESAS
